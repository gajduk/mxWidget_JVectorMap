// Generated on 2017-02-16 using generator-mendix 2.1.0 :: git+https://github.com/mendix/generator-mendix.git
/*jshint -W069*/
/*global module*/
"use strict";
...
var TEST_PATH = path.join(currentFolder, "/JVectorMapTest_v7.2/JVectorMapTest.mpr");
var WIDGET_XML = path.join(currentFolder, "/src/", pkg.name, "/", pkg.name + ".xml");
var PACKAGE_XML = path.join(currentFolder, "/src/package.xml");
var TEST_WIDGETS_FOLDER = path.join(currentFolder, "./JVectorMapTest_v7.2/widgets");
var TEST_WIDGETS_DEPLOYMENT_FOLDER = path.join(currentFolder, "./JVectorMapTest_v7.2/deployment/web/widgets");
